...
⡝⡵⡕⡀⠑⠳⠿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⠿⠛⢉⡠⡲⡫⡪⡪⡣⠀⠀{Wh}\n Enter IP target : {Gr}")  
    print()
    print(f'INFORMATION IP ADDRESS')
    try:
...
{Wh}[ + ]  C O D E   B Y  @jawir666 | @scorpooZZZ  [ + ]
{Wh}[ + ]  G I T H U B : https://github.com/ [ + ]
{Wh}[ + ]  C H A N N E L : t.me/scorpioZZZ  [ + ]
{Wh}[ + ]  C O N C T A C T : t.mr/jawir666  [ + ]
        """)
...
{Wh}[ + ]  C O D E   B Y  @jawir666 | @scorpioZZZ  [ + ]
{Wh}[ + ]  G I T H U B : https://github.com/zamsex7-spec  [ + ]
{Wh}[ + ]  C H A N N E L : t.me/scorpioZZZ  [ + ]
{Wh}[ + ]  C O N C T A C T : t.mr/jawir666  [ + ]
        """)
...
{Wh}[ + ]  C O D E   B Y  @jawir666 | @scirpioZZZ  [ + ]
{Wh}[ + ]  G I T H U B : https://github.com/  [ + ]
{Wh}[ + ]  C H A N N E L : t.me/scorpioZZZ  [ + ]
{Wh}[ + ]  C O N C T A C T : t.mr/jawir666  [ + ]
        """)
